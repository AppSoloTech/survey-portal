...
// options/questions and entries in the admin-managed tag catalog. Everything
// offered in the builder dropdowns is therefore visible and editable on the
// Tags page — there is no hardcoded preset list.
